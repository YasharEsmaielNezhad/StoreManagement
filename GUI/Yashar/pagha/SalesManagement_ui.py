...
from PySide6.QtWidgets import (QApplication, QCommandLinkButton, QHeaderView, QLabel,
...
class Ui_SalesManagement(object):
    def setupUi(self, SalesManagement):
        ...
        self.TableWidget.setGeometry(QRect(10, 50, 561, 330))
        self.TableWidget.setMinimumSize(QSize(561, 0))
        self.TableWidget.setStyleSheet(u"background-color: rgb(0, 74, 109);\n"
...
"background-color: rgb(203, 203, 151);")
    ...
    def retranslateUi(self, SalesManagement):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("SalesManagement", u"BoughtBill", None));
